...
const TIERS = [
  {
    ...
    audience: "100명 미만 추천",
    features: ["실시간 핫라인 (평일 응답)", "분기 1회 현장 방문", "무료 템플릿 라이브러리 전체", "HR 제도 검토 · 자문", "노무사 연결 (단가 매칭)"],
  },
  {
    ...
    features: ["실시간 핫라인 (우선 응답)", "월 1회 현장 방문", "템플릿 전체 (잠금 해제)", "평가 · 보상 초안 작성 지원", "노무사 연결 (우대 단가)", "분기 1회 진단 (서베이 등)"],
  },
  {
    ...
    features: ["실시간 핫라인 (상시 응답)", "월 2회+ 현장 방문", "맞춤 템플릿 제작", "제도 풀세트 함께 설계", "임원 · 팀장 1:1 코칭", "연 1회 종합 진단 포함", "노무사 무료 1회/년 포함"],
  },
];
