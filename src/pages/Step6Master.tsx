...
const TIERS = [
  ...
  },
  {
    ...
    features: ["실시간 핫라인 (우선 응답)", "월 1회 현장 방문 및 분기별 맟춤 방문", "템플릿 전체", "주요 제도 작성 지원", "리더십 진단 및 코칭", "노무사 연결 (우대 단가)"],
  },
  {
    ...
    features: ["실시간 핫라인 (상시 응답)", "월 2회+ 현장 방문", "맞춤 템플릿 제작", "제도 풀세트 설계 지원", "1:1 코칭 및 워크샵", "연 1회 종합 진단 포함", "노무사 무료 1회/년 포함"],
  },
];
